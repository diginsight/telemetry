...
namespace Common
{
    public class RecorderTraceListener : TraceListener, ISupportFilters
    {
        ...
        private static ClassConfigurationGetter<RecorderTraceListener> classConfigurationGetter;
        ...
        private void Init()
        {
            if (classConfigurationGetter == null) { classConfigurationGetter = new ClassConfigurationGetter<RecorderTraceListener>(TraceLogger.Configuration); }
