...
public static class ActivityUtils
{
    ...
    [MethodImpl(MethodImplOptions.NoInlining)]
    public static Activity CreateStandaloneRichActivity(
        string activityName,
        ActivityKind activityKind = ActivityKind.Internal,
        LogLevel logLevel = LogLevel.Debug,
        [CallerMemberName] string callerMemberName = "",
    ...
    {
        return CoreCreateRichActivity(null, null, null, activityName, activityKind, logLevel, callerMemberName, stackDepth + 1, false)!;
    }
    ...
    {
        return CoreCreateRichActivity(null, logger, null, activityName, activityKind, logLevel, callerMemberName, stackDepth + 1, false)!;
    }

    [MethodImpl(MethodImplOptions.NoInlining)]
    public static Activity StartStandaloneRichActivity(
        string activityName,
        ActivityKind activityKind = ActivityKind.Internal,
        LogLevel logLevel = LogLevel.Debug,
        [CallerMemberName] string callerMemberName = "",
    ...
    {
        return CoreCreateRichActivity(null, null, null, activityName, activityKind, logLevel, callerMemberName, stackDepth + 1, true)!;
    }
    ...
    {
        return CoreCreateRichActivity(null, logger, null, activityName, activityKind, logLevel, callerMemberName, stackDepth + 1, true)!;
    }

    [MethodImpl(MethodImplOptions.NoInlining)]
    public static Activity CreateStandaloneMethodActivity(
        object inputs,
        ActivityKind activityKind = ActivityKind.Internal,
        LogLevel logLevel = LogLevel.Debug,
        [CallerMemberName] string callerMemberName = "",
    ...
    )
    {
        ...
        return CreateStandaloneMethodActivity(() => inputs, activityKind, logLevel, callerMemberName, stackDepth + 1);
    }
    ...
    {
        return CoreCreateRichActivity(null, null, makeInputs, null, activityKind, logLevel, callerMemberName, stackDepth + 1, false)!;
    }
    ...
    )
    {
        ...
        return CreateStandaloneMethodActivity(logger, () => inputs, activityKind, logLevel, callerMemberName, stackDepth + 1);
    }
    ...
    {
        return CoreCreateRichActivity(null, logger, makeInputs, null, activityKind, logLevel, callerMemberName, stackDepth + 1, false)!;
    }

    [MethodImpl(MethodImplOptions.NoInlining)]
    public static Activity StartStandaloneMethodActivity(
        object inputs,
        ActivityKind activityKind = ActivityKind.Internal,
        LogLevel logLevel = LogLevel.Debug,
        [CallerMemberName] string callerMemberName = "",
    ...
    )
    {
        ...
        return StartStandaloneMethodActivity(() => inputs, activityKind, logLevel, callerMemberName, stackDepth + 1);
    }
    ...
    {
        return CoreCreateRichActivity(null, null, makeInputs, null, activityKind, logLevel, callerMemberName, stackDepth + 1, true)!;
    }
    ...
    )
    {
        ...
        return StartStandaloneMethodActivity(logger, () => inputs, activityKind, logLevel, callerMemberName, stackDepth + 1);
    }
    ...
    {
        return CoreCreateRichActivity(null, logger, makeInputs, null, activityKind, logLevel, callerMemberName, stackDepth + 1, true)!;
    }
    ...
    )
    {
        ...
        {
            activity = new Activity(finalActivityName);
        }
        else
        {
            activity = activitySource.CreateActivity(finalActivityName, activityKind);
            if (activity is null)
            {
                return null;
            }
