...
![Alt text](<10.01 - Introduction to Diginsight v3/01. Azure Monitor Dashboard with metrics.png>)
...
![Alt text](<10.01 - Introduction to Diginsight v3/10. use Dynamic-Configuration header to Change log level configuration.png>)
