---
title: "Make your application observable"
---
...
![Alt text](<01. Make your application observable/01. BeginMethodScope.jpg> "Diginsight telemetry Method scope")
...
![Alt text](<01. Make your application observable/02. BeginNamedScope.jpg> "Diginsight telemetry Named scope")<br>
...
## Use ILoggerProvider where ILogger class is not available
...
![Alt text](<01. Make your application observable/03. ParametersLog.jpg> "Diginsight telemetry parameters log")<br>
...
![Alt text](<01. Make your application observable/04. LeadingEllipses.jpg> "Diginsight telemetry leading ellipses")<br>
...
![Alt text](<01. Make your application observable/08. LogObjectPayload-1.png> "Diginsight telemetry leading ellipses")<br>
...
![Alt text](<01. Make your application observable/05. StartupSequenceLog.jpg> "Diginsight telemetry startup sequence log")<br>
...
## Use diginsight to observe application behaviours
...
![Alt text](<01. Make your application observable/06. HighLatencyCall.jpg> "Diginsight telemetry startup sequence log")<br>

The example below shows a call is shown where the returned payload is higher than 1MB:
![Alt text](<01. Make your application observable/07. HighPayloadCall.jpg> "Diginsight telemetry startup sequence log")<br>
