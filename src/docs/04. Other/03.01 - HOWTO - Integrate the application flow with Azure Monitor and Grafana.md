---
title: "Integrate the application flow with Azure Monitor and Grafana"
---
...
![Alt text](<03. Integrate the application flow with Azure Monitor and Grafana/01. Opentelemetry elements.jpg>)
<!-- /images/other/ -->
...
![Alt text](<03. Integrate the application flow with Azure Monitor and Grafana/02. Opentelemetry citatiion.jpg>)
<br>
...
![Alt text](<03. Integrate the application flow with Azure Monitor and Grafana/03. AddObservability.png>)
...
![Alt text](<03. Integrate the application flow with Azure Monitor and Grafana/04. ChartWithSpanDurationMetric.png>)

the same latencies can be analyzed in the following logs query of the everage latencies summarised bt :
![Alt text](<03. Integrate the application flow with Azure Monitor and Grafana/05. SpanDurationByAttribute.png>)
...
![Alt text](<03. Integrate the application flow with Azure Monitor and Grafana/06. End to end transaction detail with method names.png>)

the same latencies can be shown on a grafana dashboard (or Managed Grafana dashboard on Azure)
![Alt text](<03. Integrate the application flow with Azure Monitor and Grafana/07. Diginsight latencies on a Grafana dashboard.png>)
<br><br>
...
![Alt text](<03. Integrate the application flow with Azure Monitor and Grafana/08. use EasySampleBlazorv2.png>)
