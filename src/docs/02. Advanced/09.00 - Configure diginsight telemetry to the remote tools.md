...
## STEP 01 - Add a package reference to the package `Diginsight.Core`, `Diginsight.Diagnostics` and `Diginsight.Diagnostics.AspNetCore.OpenTelemetry`

In the first step you can just add a diginsight references to your code:
![alt text](<09.00 - Configure diginsight telemetry to the remote tools/001.01 Add Diginsight references1.png>)
