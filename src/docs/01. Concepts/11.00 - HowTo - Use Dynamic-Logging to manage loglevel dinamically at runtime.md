...
![alt text](<11. HowTo Use Dynamic-Logging/001.01a default application streaming log.png>)
...
![alt text](<11. HowTo Use Dynamic-Logging/001.02 Postman call with overloaded log levels.png>)

__This will result in the full application flow being shown__ for the specific call:
![alt text](<11. HowTo Use Dynamic-Logging/001.03 Call application flow obtained with Dynamic Logging.png>)
...
![alt text](<11. HowTo Use Dynamic-Logging/002.01 SampleWebApi startup sequence.png>)
