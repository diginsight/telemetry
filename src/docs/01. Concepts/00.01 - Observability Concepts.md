...
![alt text](<00.01 - Observability Concepts/002.00 Opentelemetry elements.png>)<!-- /images/other/ -->
...
![alt text](<00.01 - Observability Concepts/001.00 Prometheus Grafana dashboard.png>)
<br>
<br>
...
![alt text](<00.01 - Observability Concepts/001.01 Consistency across tools and code.png>)
...
![alt text](<00.01 - Observability Concepts/001.02 Consistency across applications.png>) 
<br><br>
...
Paragraph [GETTING STARTED](<00.01 Getting Started.md>) discusses basic steps we can follow to integrate diginsight telemetry.
