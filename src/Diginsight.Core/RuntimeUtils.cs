                ...
                try
                {
                    ...
                    if (current is JToken jt)
                    {
                        return jt switch
                        {
                            ...
                            _ => new HeuristicSizeResult(0, new UnreachableException($"Unsupported {nameof(JToken)} subclass")),
                        };
                    }
                    ...
                    try
                    {
                        if (current is ISizeableHeuristically ms)
                        {
                            return ms.GetSizeHeuristically(CoreGet);
                        }
