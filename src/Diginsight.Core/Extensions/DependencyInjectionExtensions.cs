...
public static class DependencyInjectionExtensions
{
    ...
    extension(IServiceCollection services)
    {
        ...
        public IServiceCollection FlagAsDynamic<TOptions>(string? name)
        ...
        /// </summary>
        /// <returns>The service collection, for chaining.</returns>
        public IServiceCollection AddClassAwareOptions()
        {
            services.AddOptions();
        ...
        /// <returns>The service collection, for chaining.</returns>
        public IServiceCollection ConfigureClassAware<TOptions>(
            IConfiguration configuration, string? sectionKey = null, Action<BinderOptions>? configureBinder = null
        )
        ...
        /// <typeparam name="TOptions">The type of options.</typeparam>
        /// <returns>The service collection, for chaining.</returns>
        public IServiceCollection ConfigureClassAwareOptions<TOptions>()
            where TOptions : class
        {
        ...
        /// <returns>The service collection, for chaining.</returns>
        public IServiceCollection ConfigureClassAwareOptions(Type type)
        {
            return services
        ...
        /// <returns>The service collection, for chaining.</returns>
        public IServiceCollection ConfigureClassAwareOptions(object instance)
        {
            return services
        ...
        private IServiceCollection ConfigureClassAwareOptions(
            Type type, Func<Type, ServiceDescriptor> makeDescriptor
        )
        {
            services.AddClassAwareOptions();
        ...
        /// </summary>
        /// <returns>The service collection, for chaining.</returns>
        public IServiceCollection AddVolatileConfiguration()
        {
        ...
        /// <returns>The service collection, for chaining.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public IServiceCollection VolatilelyConfigure<TOptions>()
        ...
        /// <param name="name">The name of the options instance.</param>
        /// <returns>The service collection, for chaining.</returns>
        public IServiceCollection VolatilelyConfigure<TOptions>(string name)
            where TOptions : class, IVolatilelyConfigurable
        {
            services
                .AddOptions()
        ...
        /// <returns>The service collection, for chaining.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public IServiceCollection VolatilelyConfigureClassAware<TOptions>()
            where TOptions : class, IVolatilelyConfigurable
        {
        ...
        /// <param name="name">The name of the options instance.</param>
        /// <returns>The service collection, for chaining.</returns>
        public IServiceCollection VolatilelyConfigureClassAware<TOptions>(string name)
            where TOptions : class, IVolatilelyConfigurable
        {
            services.AddClassAwareOptions();
        ...
        /// <returns>The service collection, for chaining.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public IServiceCollection VolatilelyPostConfigure<TOptions>()
            where TOptions : class, IVolatilelyConfigurable
        {
        ...
        /// <param name="name">The name of the options instance.</param>
        /// <returns>The service collection, for chaining.</returns>
        public IServiceCollection VolatilelyPostConfigure<TOptions>(string name)
            where TOptions : class, IVolatilelyConfigurable
        {
            services
                .AddOptions()
        ...
        /// <returns>The service collection, for chaining.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public IServiceCollection VolatilelyPostConfigureClassAware<TOptions>()
            where TOptions : class, IVolatilelyConfigurable
        {
        ...
        /// <param name="name">The name of the options instance.</param>
        /// <returns>The service collection, for chaining.</returns>
        public IServiceCollection VolatilelyPostConfigureClassAware<TOptions>(string name)
            where TOptions : class, IVolatilelyConfigurable
        {
            services.AddClassAwareOptions();
        ...
        /// </summary>
        /// <returns>The service collection, for chaining.</returns>
        public IServiceCollection AddLoggerFactorySetter()
        {
