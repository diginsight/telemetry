...
/// <summary>
/// Represents an interface for dynamically configurable option objects.
/// </summary>
/// <remarks>
...
{
    /// <summary>
    /// Invoked by the options system to fill this instance with dynamic configuration.
    /// </summary>
    /// <remarks>
    ///     <para>Implementors should return either the object itself, or a wrapper that "masks" the properties available for dynamic configuration.</para>
