...
namespace Common
{
    public class SerilogTraceListener : TraceListener, ISupportFilters
    {
        ...
        private static ClassConfigurationGetter<SerilogTraceListener> classConfigurationGetter;
        ...
        private void Init()
        {
            using (var sec = this.GetCodeSection())
            {
                if (classConfigurationGetter == null) { classConfigurationGetter = new ClassConfigurationGetter<SerilogTraceListener>(TraceLogger.Configuration); }
                ...
                var logFolder = classConfigurationGetter.Get(CONFIGSETTING_LOGFOLDER, CONFIGDEFAULT_LOGFOLDER);
